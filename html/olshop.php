					...
					if (data.error == "false") {
						...
						if (null != container && null != list) {
							...
							for (var key in list) {
								...
								labelPhone.innerHTML = "联系电话： ";
								div.appendChild(labelPhone);

								var phone = document.createElement("span");
								phone.innerHTML = list[key].phone;
	...
	<body>
		<div class="container-fluid" style="height: 50px; margin-top: 10px; background-color: rgba(0, 0, 255, 0.32);">
			<div class="row" style="position: relative; top: 10px;">
				...
				<div class="col-xs-6 col-md-6"><h4 style="text-align: center; color: white">线下商家</h4></div>
		...
		<div id="result_block">
			...
			?>
					...
					<div>
						...
						<br>
						<span><label>联系电话： </label><?php echo $row["PhoneNum"]; ?></span>
