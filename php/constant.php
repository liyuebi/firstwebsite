...
// 	$refererBonusLevel = 13;	// 推荐奖有效层次
	...
	// 每一层给的总分红奖励
	$levelBonus = array(0, 360, 1360, 2020, 3520, 6530, 10050, 13060, 20080, 33100, 50150, 67200, 135300, 202000);
	// 每一层每天的分红奖励额度
	$levelDayBonus = array(0, 12, 45, 68, 118, 218, 335, 435, 670, 1103, 1672, 2240, 4510, 6733);
	// 每一层给的奖励
